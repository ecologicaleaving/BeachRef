...
- **TODO**: Rientro del baseline `.audit-baseline.json` verso zero (2721 finding bloccanti dopo #56: 2677 TS, 5 ESLint error, ~39 error-handling; **0 Critical, 0 security**)
