  ...
  matchCoreToLegacy(core: BeachMatchCore): BeachMatch {
    try {
      ...
      const legacy: BeachMatch = {
        ...
        TeamAFederationCode: core.team1.countryCode,
        TeamBFederationCode: core.team2.countryCode,
        ...
        Round: core.round,
        Referee1Name: core.refereeAssignments?.[0]?.refereeName,
        Referee2Name: core.refereeAssignments?.[1]?.refereeName,
        NoReferee1: core.refereeAssignments?.[0]?.refereeId,
        NoReferee2: core.refereeAssignments?.[1]?.refereeId,
        Referee1FederationCode: core.refereeAssignments?.[0]?.federationCode,
        Referee2FederationCode: core.refereeAssignments?.[1]?.federationCode,
